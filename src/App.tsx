import React, { useState } from 'react';
    ...
    function App() {
      ...
      const videoTestimonialsData = [
        {
          name: "Carolina Silva",
          vimeoUrl: "https://player.vimeo.com/video/1082032380?h=6f1d3a7193"
        },
        {
          name: "Gustavo Lira",
          vimeoUrl: "https://player.vimeo.com/video/1082032406?h=13a462ef7c"
        },
        {
          name: "Laís Sousa",
          vimeoUrl: "https://player.vimeo.com/video/1082032355?h=1d958b1caa"
        }
      ];
      ...
      return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
              <div className="text-center">
                <img 
                  ...
                  className="mx-auto h-32 md:h-40 w-auto mb-3"
                />
          ...
          <section className="py-16 bg-gray-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-bold text-center mb-12">Depoimentos em Vídeo</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {videoTestimonialsData.map((video, index) => (
                  <div key={index} className="bg-white p-6 rounded-xl shadow-md">
                    <h3 className="text-lg font-semibold mb-4 text-center">{video.name}</h3>
                    <div className="aspect-[9/16]">
                      <iframe
                        ...
                        title={`Depoimento em vídeo de ${video.name}`}
                      ></iframe>
                    </div>
                  </div>
                ))}
